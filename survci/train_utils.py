...
from surv_ci.losses import conditional_loss,unconditional_loss,mse_loss,mse_total,imb_loss,factual_loss,unconditional_mse
from surv_ci.utilities import get_optimizer
...
def pretrain(model, t_train, e_train, W_train, t_valid, e_valid,W_valid,
  ...
  for _ in tqdm(range(n_iter)):
    ...
    loss = unconditional_loss(premodel, t_train, e_train, W_train)
    ...
    valid_loss = unconditional_loss(premodel, t_valid, e_valid, W_valid)
...
def train_survci(model,
              ...
              x_valid, t_valid, e_valid,W_valid,
